        ...
        <div class="container p-2 mt-5 shadow-lg p-1 mb-3 bg-white rounded" style=" border-radius: 20px; height: 600px;">
            <form method="POST" action="{{ route('store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <p class="px-2"><input class="form-control-file" style="width: 100%; padding-top: 0.2em; padding-bottom:0.2em; padding-left:0.2em;" type="file" name="image" accept="image/png, image/jpeg"></p>
                </div>
